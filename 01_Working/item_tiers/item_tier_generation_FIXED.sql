...
SELECT '============================================================================' AS '';
SELECT 'Review checks above. Press F9 to continue or stop here to review.' AS '';
SELECT '============================================================================' AS '';
...
SELECT
    ...
    i.minstatus,
    i.Name,
    -- Stats: ×1.10, inject +1 only if item already has some stats OR is weapon/armor
    GREATEST(FLOOR(COALESCE(i.aagi,0) * 1.10),
        CASE WHEN COALESCE(i.aagi,0) = 0 AND (i.astr + i.asta + i.adex + i.aint + i.awis + i.acha > 0 OR i.ac > 0) THEN 1 ELSE 0 END) AS aagi,
